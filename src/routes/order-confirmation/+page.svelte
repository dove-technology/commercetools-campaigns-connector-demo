...
<div class="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
	<div class="max-w-xl">
		...
		<p class="mt-2 text-base text-gray-500">Your order will be with you soon.</p>
	</div>
	...
	<div class="mt-10 border-t border-gray-200">
		...
		<div class="flex space-x-6 border-b border-gray-200 py-10">
			<img
				src="https://tailwindui.com/plus/img/ecommerce-images/confirmation-page-05-product-01.jpg"
			...
			<div class="flex flex-auto flex-col">
				<div>
					<h4 class="font-medium text-gray-900">Cold Brew Bottle</h4>
					<p class="mt-2 text-sm text-gray-600">
						This glass bottle comes with a mesh insert for steeping tea or cold-brewing coffee. Pour
						from any angle and remove the top for easy cleaning.
					</p>
				</div>
